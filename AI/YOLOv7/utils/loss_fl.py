...
class FocalLoss(nn.Module):
    ...
    def forward(self, pred, true):
        ...
        F_loss = self.alpha * (1.000001 - p_t) ** self.gamma * BCE_loss # non-zero power for gradient stability
...
class ComputeLossOTA:
    ...
    def __init__(self, model, autobalance=False):
        ...
        g = h['fl_gamma']  # focal loss gamma
        if g > 0:
            BCEcls, BCEobj = FocalLoss(BCEcls, g, alpha=0.25), FocalLoss(BCEobj, g, alpha=0.25)
