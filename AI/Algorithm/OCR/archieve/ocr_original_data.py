'''
이 스크립트는 EasyOCR을 사용하여 원본 이미지 데이터에서 텍스트를 인식하고, 인식된 결과를 텍스트 파일로 저장하며, 시각화된 이미지를 생성하여 저장합니다. 영어와 한국어를 인식할 수 있습니다.
'''
...
# 이미지 경로 설정
input_dir = '/home/jdh251425/2025_DKU_Capstone/AI/Algorithm/OCR/cropped_datasets/original_data'
